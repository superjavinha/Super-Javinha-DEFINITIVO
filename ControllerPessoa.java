...
public class ControllerPessoa {
     ...
     */
    public Funcionario cadastrarFuncionario(String funcao, float salario, String nome, String cpf, LocalDate dataNascimento, Endereco endereco){
        Funcionario f = new Funcionario(funcao, salario, nome, cpf, dataNascimento, endereco);
     ...
     */
    private Funcionario obterFuncionario(String CPF){
     ...
     */
    public Motorista cadastrarMotorista(String CNH, String nome, String CPF, LocalDate dataNascimento, Endereco endereco){
        Motorista m = new Motorista(CNH, nome, CPF, dataNascimento, endereco);
     ...
     */
    private Motorista obterMotorista(String CPF){
